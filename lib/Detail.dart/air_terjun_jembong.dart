...
class AirTerjunJembongDetail extends StatelessWidget {
  final String title;
  final String imagePath;

  AirTerjunJembongDetail({required this.title, required this.imagePath});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(title),
        backgroundColor:
            Colors.blueAccent, // Sesuaikan warna latar belakang sesuai kebutuhan
      ),
